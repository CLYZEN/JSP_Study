...
<body>
	<h2>학생 정보</h2> [<a href="/jsp_study/studentControl">새로고침</a> ]
	<hr>
	<table border = "1">
		<tr>
			<th>id</th>
	...
	<form action="/jsp_study/studentControl?action=insert" method = "post">
		...
		<label>대학</label><input type="text" name="univ" id="univ" /> <br />
		<label>생일</label><input type="text" name="birth" id="birth" /> <br />
